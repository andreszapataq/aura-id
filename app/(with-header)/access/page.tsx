        ...
        <div className="bg-gradient-to-r from-blue-600 to-blue-700 text-white px-6 py-3 shadow-md">
          <div className="flex items-center justify-between max-w-7xl mx-auto">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h2 className="text-lg font-semibold">Terminal Kiosco</h2>
            ...
            <div className="text-right">
              ...
              <div className="text-xs text-blue-100">{new Date().toLocaleDateString('es-CO', { weekday: 'long', day: 'numeric', month: 'long' })}</div>
            </div>
          </div>
        </div>
      )}
